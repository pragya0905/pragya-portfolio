...
## Who Pragya is
Pragya Kumari is a Software Development Engineer with 3+ years of experience spanning an SDE role at Amazon, startup founding, and software internships (DivineAI, HighRadius) — specializing in scalable AWS microservices, REST APIs, event-driven architectures, and production LLM integrations. At Amazon she delivered measurable impact through fraud-prevention (95% match rate across 20+ fulfillment centers), a 45% latency cut on a legacy service migration, and observability systems that dropped the fatal error rate from 90% to 5%. She's now the Founder of Aurique Life, a digital wellness brand she started and runs herself, building a live e-commerce platform. She is based in India.
...
1. **Aurique Life** — her primary focus, a live, revenue-generating e-commerce platform that she built and runs solo end to end, architecture to product.
