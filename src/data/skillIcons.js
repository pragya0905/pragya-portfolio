import { Brain, ChartSpline, MessageSquare, Network, PenTool, Webhook } from "lucide-react";
...
export const SKILL_SHORT_LABELS = {
  "AWS (EC2, S3, Lambda, DynamoDB, CloudFront, IAM, SAM, CloudWatch)": "AWS (8 services)",
};
